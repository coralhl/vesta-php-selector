...
for ver in $vers; do
    ...
    cp fpm/php-fpm-$ver.stpl /usr/local/vesta/data/templates/web/apache2/php-fpm-$ver.stpl
    cp fpm/php-fpm-$ver.tpl  /usr/local/vesta/data/templates/web/apache2/php-fpm-$ver.tpl
    cp fpm/php-fpm-$ver.sh   /usr/local/vesta/data/templates/web/apache2/php-fpm-$ver.sh
